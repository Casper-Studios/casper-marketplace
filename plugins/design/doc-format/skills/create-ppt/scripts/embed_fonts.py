...
STATUS: ON BY DEFAULT. render.js runs this post-processor after each successful build.
Embedding fails soft, so a font problem never destroys an otherwise valid deck.
